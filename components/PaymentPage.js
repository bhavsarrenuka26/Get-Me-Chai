                ...
                <div className="payment flex gap-2 w-[90%] mt-11">
                    ...
                    <div className="makepayment bg-slate-900 w-1/2 rounded-lg p-10">
                        ...
                        <div className="flex  flex-col gap-2">
                            ...
                            <button onClick={()=>pay(Number.parseInt(paymentform.amount)*100)}className="text-white bg-gradient-to-br from-purple-900 to-blue-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" >Pay</button>
